							...
							<form:form servletRelativeAction="/cadastro/avaliacao"
								...
								<div id="dobrasM">
									...
									<div class="form-group">
										...
										<p class="alert-warning text-center">
											<form:errors path="avaliacao.dToracica" />
										</p>
										<form:input path="avaliacao.dToracica"
											onkeyup="validar(this,'num')" maxlength="6" value="0"
											class="form-control" />
									</div>
									...
									<div class="form-group">
										...
										<p class="alert-warning text-center">
											<form:errors path="avaliacao.dAbdominal" />
										</p>
										<form:input path="avaliacao.dAbdominal"
											onkeyup="validar(this,'num')" maxlength="6" value="0"
											class="form-control" />
									</div>
								...
								<div id="dobrasF">
									...
									<div class="form-group">
										...
										<p class="alert-warning text-center">
											<form:errors path="avaliacao.dTriciptal" />
										</p>
										<form:input path="avaliacao.dTriciptal"
											onkeyup="validar(this,'num')" maxlength="6" value="0"
											class="form-control" />
									</div>
									...
									<div class="form-group">
										...
										<p class="alert-warning text-center">
											<form:errors path="avaliacao.dSupraIliaca" />
										</p>
										<form:input path="avaliacao.dSupraIliaca"
											onkeyup="validar(this,'num')" maxlength="6" value="0"
											class="form-control" />
									</div>
								...
								<div class="form-group">
									...
									<p class="alert-warning text-center">
										<form:errors path="avaliacao.dCoxa" />
									</p>
									<form:input path="avaliacao.dCoxa" maxlength="6" value="0"
								...
								<br />
								<div class="text-center">
									<label>TESTE DE RESISTENCIA:</label>
								</div>
								<br />

								<div class="form-group">
									<label>ABDOMINAIS POR 1 MINUTO *</label>
									<p class="alert-warning text-center">
								...
								<div class="form-group">
									<label>FLEXÕES POR 1 MINUTO *</label>
									<p class="alert-warning text-center">
